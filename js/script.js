...
const personalMovieDB = {
    ...
    writeYourGenres: function () {
        ...
        //                console.log('Ввели некоретные данные или не ввели их совсем');
        //                i--;                  
        //            } else {
        ...
        for (let i = 1; i < 2; i++) { 
            ...
            personalMovieDB.genres.forEach(function(item, numberOfItem) {
                console.log(`Любимый жанр ${numberOfItem + 1} - это ${item}`);
            });            
        }  
    }
};   
